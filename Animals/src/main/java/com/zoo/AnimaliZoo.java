...
public class AnimaliZoo {
	...
	public static void main(String[] args) {
		...
		private static void displayLongTail(List<AnimalsWithTail> animals_tail) {
	        ...
	        AnimalsWithTail Lenght = Collections.max(animals_tail, Comparator.comparingInt(a -> a.getLongestTail()));
		...
		private static void displayLargeWing(List<AnimalsWithWings> animals_wings) {
	        ...
	        AnimalsWithWings Largest = Collections.max(animals_wings, Comparator.comparingInt(a -> a.getLargestWings()));
